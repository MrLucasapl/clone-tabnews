    ...
    <div>
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          ...
          materiais (informações ou software) no site worldbit , apenas para
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          ...
          dessas restrições e poderá ser rescindida por worldbit a qualquer
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          Os materiais exibidos no site da worldbit podem incluir erros
          técnicos, tipográficos ou fotográficos. worldbit não garante que
          qualquer material em seu site seja preciso, completo ou atual.
          worldbit pode fazer alterações nos materiais contidos em seu site a
          qualquer momento, sem aviso prévio. No entanto, worldbit não se
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          O worldbit não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por worldbit do site. O uso de
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          O worldbit pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          ...
          leis do worldbit e você se submete irrevogavelmente à jurisdição
