...
export default function Privacidade() {
  return (
    <div>
      ...
      política do worldbit respeitar a sua privacidade em relação a qualquer
      informação sua que possamos coletar no site{' '}
      <a href="https://worldbit.com.br/">worldbit</a>, e outros sites que
      ...
      meios justos e legais, com o seu conhecimento e consentimento. Também
      ...
      que não são operados por nós. Esteja ciente de que não temos controle
      ...
      pessoais, entre em contacto connosco. O serviço Google AdSense que usamos
      para veicular publicidade usa um cookie DoubleClick para veicular anúncios
      mais relevantes em toda a Web e limitar o número de vezes que um
      determinado anúncio é exibido para você. Para mais informações sobre o
      Google AdSense, consulte as FAQs oficiais sobre privacidade do Google
      AdSense. Utilizamos anúncios para compensar os custos de funcionamento
      ...
      apresentando coisas semelhantes que possam ser do seu interesse. Vários
      parceiros anunciam em nosso nome e os cookies de rastreamento de afiliados
      simplesmente nos permitem ver se nossos clientes acessaram o site através
      de um dos sites de nossos parceiros, para que possamos creditá-los
      ...
      conteúdos e da informação que o worldbit oferece no site e com caráter
      enunciativo, mas não limitativo: Não se envolver em atividades que sejam
      ilegais ou contrárias à boa fé a à ordem pública; Não difundir propaganda
      ou conteúdo de natureza racista, xenofóbica, ou azar, qualquer tipo de
      pornografia ilegal, de apologia ao terrorismo ou contra os direitos
      humanos; Não causar danos aos sistemas físicos (hardwares) e lógicos
      (softwares) do worldbit, de seus fornecedores ou terceiros, para
      ...
      mencionados. Mais informações Esperemos que esteja esclarecido e, como
      mencionado anteriormente, se houver algo que você não tem certeza se
      precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso
      interaja com um dos recursos que você usa em nosso site. Esta política é
      efetiva a partir de 6 February 2025 19:56
    </div>
  );
}
